        ...
        <div class="container">
            <div class="span8">
                ...
                <div class="hero-unit span4">
                    ...
                    <h2>Geek;Hacker;Entrepreneur;</h2>
                    <p>
                ...
                <dl>
                    ...
                    <ul>
                        ...
                        <li>Maintained the server, with specific focus on security</li>
                    </ul>
                </dl>  
                ...
                <dl>
                    ...
                    <ul>
                        ...
                        <li>On the organising team with 6 other awesome geeks.</li>
                    </ul>
                </dl>  
                    ...
                    <ul>
                        ...
                        <li>NUSHackers (<a href="http://nushackers.org" target="_blank">Link</a>): <strong>Aug 2010 - Present</strong>
                            <ul>
                                ...
                                <li>Organised Friday Hacks, a weekly event to get students to build things</li>
...
<!--
    var string1 = "laurenceputra";var string2 = "@";var string3 = "gmail.com";var string4 = string1 + string2 + string3;document.write("<a href=" + "mail" + "to:" + string1 + string2 + string3 + ">" + string4 + "</a>");
//-->
</script>
                </p>
